...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 25 16:03:13 2023
...
matrix_plot.auroc(auroc, beta_s, axis_title)
matrix_plot.plot_line_final(axis_title, beta_s, flag_rate_a, flag_rate_b, base_ratea, base_rateb, recall_a, recall_b, tpr_whole, fpr_a, fpr_b, fpr_whole, ppr_a, ppr_b, ppr_whole)


bias_type = "sample size bias"

# save.save(bias_type, data_type, method, beta_s, 
